...
const About = () => {
    return (
        <>
            <section className="w-full mx-auto mt-16 rounded bg-gray-50 xl:max-w-screen-xl dark:bg-gray-800">
                <h4 className="py-8 px-12 text-xl italic text-gray-800 bg-white font-serif md:text-2xl dark:text-white dark:bg-gray-900">
